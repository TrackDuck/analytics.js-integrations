...
Frontleaf.prototype.load = function(callback){
  if (document.getElementById('_fl')) return callback.async(callback);

  var script = load(window._flBaseUrl + '/lib/tracker.js', callback);
  script.id = '_fl';
};
